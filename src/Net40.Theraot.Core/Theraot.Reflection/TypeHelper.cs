...
public static class TypeHelper
{
    public static MethodInfo GetDelegateMethodInfo(Type delegateType)
    {
            ...
            MethodInfo methodInfo = RuntimeReflectionExtensions.GetRuntimeMethods(delegateType)
                .FirstOrDefault((MethodInfo info) => string.Equals(info.Name, "Invoke", StringComparison.Ordinal));
            if (methodInfo == null)
            {
                throw new ArgumentException("Not a delegate.", "delegateType");
            }
    ...
    public static MethodInfo FindConversionOperator(IEnumerable<MethodInfo> methods, Type typeFrom, Type typeTo,
        bool implicitOnly)
    {
            return (from method in methods
                where string.Equals(method.Name, "op_Implicit", StringComparison.Ordinal) || (!implicitOnly &&
    ...
    public static bool IsImplicitNumericConversion(Type source, Type target)
    {
            ...
            {
                if (target == typeof(short) || target == typeof(int) || target == typeof(long) ||
            ...
            {
                if (target == typeof(short) || target == typeof(ushort) || target == typeof(int) ||
            ...
            {
                if (target == typeof(int) || target == typeof(long) || target == typeof(float) ||
            ...
            {
                if (target == typeof(int) || target == typeof(uint) || target == typeof(long) ||
                    target == typeof(ulong) || target == typeof(float) || target == typeof(double) ||
            ...
            {
                if (target == typeof(long) || target == typeof(float) || target == typeof(double) ||
                    target == typeof(decimal))
                {
                    return true;
                }
            ...
            {
                if (target == typeof(ulong) || target == typeof(float) || target == typeof(double) ||
                    target == typeof(decimal))
                {
                    return true;
                }
            ...
            {
                if (target == typeof(ushort) || target == typeof(int) || target == typeof(uint) ||
