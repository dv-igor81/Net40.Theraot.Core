...
[DebuggerNonUserCode]
public class ReadOnlyPromiseNeedle<T> : ReadOnlyPromise, ICacheNeedle<T>, INeedle<T>, IReadOnlyNeedle<T>, IPromise<T>, IPromise, IEquatable<ReadOnlyPromiseNeedle<T>>
{
