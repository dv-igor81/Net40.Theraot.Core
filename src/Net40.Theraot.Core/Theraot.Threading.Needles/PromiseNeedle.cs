...
[DebuggerNonUserCode]
public class PromiseNeedle<T> : Promise, ICacheNeedle<T>, INeedle<T>, IReadOnlyNeedle<T>, IPromise<T>, IPromise, IEquatable<PromiseNeedle<T>>
{
	...
	public static bool operator ==(PromiseNeedle<T> left, PromiseNeedle<T> right)
	{
		return ((object)left == null) ? ((object)right == null) : ((object)right != null && EqualityComparer<T>.Default.Equals(left._target, right._target));
	}
