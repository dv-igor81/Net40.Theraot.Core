...
{
	private static readonly MethodInfo _methodGetAttributeFlagsImpl = typeof(Type).GetMethod("GetAttributeFlagsImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodGetConstructorImpl = typeof(Type).GetMethod("GetConstructorImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodGetMember = typeof(Type).GetMethod("GetMember", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[3]
	{
		typeof(string),
		typeof(MemberTypes),
		typeof(BindingFlags)
	...
	private static readonly MethodInfo _methodGetMethodImpl = typeof(Type).GetMethod("GetMethodImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodGetPropertyImpl = typeof(Type).GetMethod("GetPropertyImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodHasElementTypeImpl = typeof(Type).GetMethod("HasElementTypeImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsArrayImpl = typeof(Type).GetMethod("IsArrayImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsByRefImpl = typeof(Type).GetMethod("IsByRefImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsComObjectImpl = typeof(Type).GetMethod("IsCOMObjectImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsContextfulImpl = typeof(Type).GetMethod("IsContextfulImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsMarshalByRefImpl = typeof(Type).GetMethod("IsMarshalByRefImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsPointerImpl = typeof(Type).GetMethod("IsPointerImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsPrimitiveImpl = typeof(Type).GetMethod("IsPrimitiveImpl", BindingFlags.Instance | BindingFlags.NonPublic);

	private static readonly MethodInfo _methodIsValueTypeImpl = typeof(Type).GetMethod("IsValueTypeImpl", BindingFlags.Instance | BindingFlags.NonPublic);
	...
	{
		_type = type;
		DeclaredConstructors = type.GetConstructors(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		DeclaredEvents = type.GetEvents(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		DeclaredFields = type.GetFields(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		DeclaredMembers = type.GetMembers(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		DeclaredMethods = type.GetMethods(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		DeclaredNestedTypes = (from nt in type.GetNestedTypes(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)
			select new TypeInfo(nt)).ToList().AsReadOnly();
		DeclaredProperties = type.GetProperties(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
	...
	{
		return DeclaredEvents.FirstOrDefault((EventInfo e) => string.Equals(e.Name, name, StringComparison.Ordinal));
	}

	public virtual FieldInfo? GetDeclaredField(string name)
	{
		return DeclaredFields.FirstOrDefault((FieldInfo f) => string.Equals(f.Name, name, StringComparison.Ordinal));
	}

	public virtual MethodInfo? GetDeclaredMethod(string name)
	{
		return DeclaredMethods.FirstOrDefault((MethodInfo m) => string.Equals(m.Name, name, StringComparison.Ordinal));
	}
	...
	{
		return DeclaredProperties.FirstOrDefault((PropertyInfo p) => string.Equals(p.Name, name, StringComparison.Ordinal));
	}
	...
	{
		return (ConstructorInfo)_methodGetConstructorImpl.Invoke(_type, new object[5] { bindingAttr, binder, callConvention, _type, modifiers });
	}

	protected override MethodInfo GetMethodImpl(string name, BindingFlags bindingAttr, Binder binder, CallingConventions callConvention, Type[] types, ParameterModifier[] modifiers)
	{
		return (MethodInfo)_methodGetMethodImpl.Invoke(_type, new object[6] { name, bindingAttr, binder, callConvention, _type, modifiers });
	}

	protected override PropertyInfo GetPropertyImpl(string name, BindingFlags bindingAttr, Binder binder, Type returnType, Type[] types, ParameterModifier[] modifiers)
	{
		return (PropertyInfo)_methodGetPropertyImpl.Invoke(_type, new object[6] { name, bindingAttr, binder, returnType, _type, modifiers });
	}
