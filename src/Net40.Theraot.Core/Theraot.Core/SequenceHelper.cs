...
public static class SequenceHelper
{
    ...
    public static IEnumerable<TOutput> ExploreSequence<TInput, TOutput>(TInput initial, TInput endCondition,
        Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector)
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
            ...
            return ExploreSequenceExtracted(initial, endCondition, next, resultSelector,
                EqualityComparer<TInput>.Default);
        }

    public static IEnumerable<TOutput> ExploreSequence<TInput, TOutput>(TInput initial, TInput endCondition,
        Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector, IEqualityComparer<TInput> comparer)
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    private static IEnumerable<TOutput> ExploreSequenceExtracted<TInput, TOutput>(TInput initial,
        TInput endCondition, Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector,
    ...
    public static IEnumerable<TOutput> ExploreSequenceUntilNull<TInput, TOutput>(TInput initial,
        Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector) where TInput : class
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    public static IEnumerable<TOutput> ExploreSequenceUntilNull<TInput, TOutput>(TInput? initial,
        Func<TInput, TInput?> next, Func<TInput, TOutput> resultSelector) where TInput : struct
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    private static IEnumerable<TOutput> ExploreSequenceExtractedUntilNull<TInput, TOutput>(TInput initial,
        Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector) where TInput : class
    {
            TInput current = initial;
            if (current == null)
        ...
        where T : class
    {
            ...
            return ExploreSequenceExtractedUntilNull(initial, endCondition, next, FuncHelper.GetIdentityFunc<T>(),
    ...
    public static IEnumerable<T> ExploreSequenceUntilNull<T>(T? initial, T? endCondition, Func<T, T?> next,
        IEqualityComparer<T> comparer) where T : struct
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    public static IEnumerable<TOutput> ExploreSequenceUntilNull<TInput, TOutput>(TInput initial,
        TInput endCondition, Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector) where TInput : class
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
            ...
            return ExploreSequenceExtractedUntilNull(initial, endCondition, next, resultSelector,
                EqualityComparer<TInput>.Default);
        }

    public static IEnumerable<TOutput> ExploreSequenceUntilNull<TInput, TOutput>(TInput? initial,
        TInput endCondition, Func<TInput, TInput?> next, Func<TInput, TOutput> resultSelector) where TInput : struct
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    public static IEnumerable<TOutput> ExploreSequenceUntilNull<TInput, TOutput>(TInput initial,
        TInput endCondition, Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector,
        IEqualityComparer<TInput> comparer) where TInput : class
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    public static IEnumerable<TOutput> ExploreSequenceUntilNull<TInput, TOutput>(TInput? initial,
        TInput endCondition, Func<TInput, TInput?> next, Func<TInput, TOutput> resultSelector,
        IEqualityComparer<TInput> comparer) where TInput : struct
    {
            if (next == null)
            {
                throw new ArgumentNullException("next");
    ...
    public static IEnumerable<T> ExploreCircularSequence<T>(T initial, Func<T, T> next,
        IEqualityComparer<T> comparer)
    {
            if (next == null)
            {
    ...
    public static IEnumerable<TOutput> ExploreCircularSequence<TInput, TOutput>(TInput initial,
        Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector, IEqualityComparer<TInput> comparer)
    {
            if (next == null)
            {
    ...
    private static IEnumerable<TOutput> ExploreCircularSequenceExtracted<TInput, TOutput>(TInput initial,
        Func<TInput, TInput> next, Func<TInput, TOutput> resultSelector, IEqualityComparer<TInput> comparer)
    {
    ...
    private static HashSet<T> GetCircularSequenceExtracted<T>(T initial, Func<T, T> next,
        IEqualityComparer<T> comparer)
    {
        ...
        where T : class
    {
            ...
            return ExploreSequenceUntilNull(first, next).Intersect(ExploreSequenceUntilNull(second, next), comparer)
                .FirstOrDefault();
        }
