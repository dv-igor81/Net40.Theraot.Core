...
{
    private const TaskContinuationOptions _conditionMask =
        ...
        CancellationToken cancellationToken, TaskContinuationOptions continuationOptions, TaskScheduler scheduler)
    {
        ...
        return ContinueWithExtracted(task, continuationAction, state, ref continuationOptions, scheduler,
            cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        TaskContinuationOptions continuationOptions = TaskContinuationOptions.None;
        return ContinueWithExtracted(task, continuationAction, state, ref continuationOptions,
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task<TResult> ContinueWith<TResult>(this Task task,
        ...
        TaskContinuationOptions continuationOptions, TaskScheduler scheduler)
    {
        ...
        return ContinueWithExtracted(task, continuationFunction, state, ref continuationOptions, scheduler,
            cancellationToken);
    }

    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task<TResult> ContinueWith<TResult>(this Task task,
        Func<Task, object, TResult> continuationFunction, object state, TaskScheduler scheduler)
    {
        if (task == null)
        {
            throw new NullReferenceException();
        ...
        Func<Task, object, TResult> continuationFunction, object state, CancellationToken cancellationToken)
    {
        ...
        TaskContinuationOptions continuationOptions = TaskContinuationOptions.None;
        return ContinueWithExtracted(task, continuationFunction, state, ref continuationOptions,
            TaskScheduler.Current, cancellationToken);
    }
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task ContinueWith<TResult>(this Task<TResult> task,
        Action<Task<TResult>, object> continuationAction, object state, CancellationToken cancellationToken,
        TaskContinuationOptions continuationOptions, TaskScheduler scheduler)
    {
        if (task == null)
        {
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task ContinueWith<TResult>(this Task<TResult> task,
        Action<Task<TResult>, object> continuationAction, object state, TaskScheduler scheduler)
    {
        if (task == null)
        {
            throw new NullReferenceException();
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task ContinueWith<TResult>(this Task<TResult> task,
        Action<Task<TResult>, object> continuationAction, object state, TaskContinuationOptions continuationOptions)
    {
        if (task == null)
        {
            throw new NullReferenceException();
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task ContinueWith<TResult>(this Task<TResult> task,
        Action<Task<TResult>, object> continuationAction, object state)
    {
        if (task == null)
        {
            throw new NullReferenceException();
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task<TResult> ContinueWith<TResult>(this Task<TResult> task,
        Func<Task<TResult>, object, TResult> continuationFunction, object state,
        CancellationToken cancellationToken, TaskContinuationOptions continuationOptions, TaskScheduler scheduler)
    {
        if (task == null)
        {
    ...
    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    public static Task<TResult> ContinueWith<TResult>(this Task<TResult> task,
        Func<Task<TResult>, object, TResult> continuationFunction, object state, TaskScheduler scheduler)
    {
        if (task == null)
        {
            throw new NullReferenceException();
    ...
    private static Task ContinueWithExtracted(Task task, Action<Task, object> continuationAction, object state,
        ref TaskContinuationOptions continuationOptions, TaskScheduler scheduler,
        CancellationToken cancellationToken)
    {
    ...
    private static Task ContinueWithExtracted<TResult>(Task<TResult> task,
        Action<Task<TResult>, object> continuationAction, object state,
        ref TaskContinuationOptions continuationOptions, TaskScheduler scheduler,
        CancellationToken cancellationToken)
    {
    ...
    private static Task<TResult> ContinueWithExtracted<TResult>(Task task,
        Func<Task, object, TResult> continuationFunction, object state,
        ref TaskContinuationOptions continuationOptions, TaskScheduler scheduler,
        CancellationToken cancellationToken)
    {
    ...
    private static Task<TResult> ContinueWithExtracted<TResult>(Task<TResult> task,
        Func<Task<TResult>, object, TResult> continuationFunction, object state,
        ref TaskContinuationOptions continuationOptions, TaskScheduler scheduler,
        CancellationToken cancellationToken)
    {
    ...
    private static void RegisterCancellation<TResult>(TaskCompletionSource<TResult> source,
        ref CancellationToken cancellationToken)
    {
        cancellationToken.Register(delegate { source.TrySetCanceled(); });
    }

    [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
    private static TaskContinuationOptions RemoveConditions(ref TaskContinuationOptions continuationOptions)
    {
        TaskContinuationOptions result = continuationOptions & (TaskContinuationOptions.OnlyOnRanToCompletion |
