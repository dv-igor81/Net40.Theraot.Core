...
public static class TaskEx
{
	...
	public static Task<Task<TResult>> WhenAny<TResult>(IEnumerable<Task<TResult>> tasks)
	{
		...
		Task.Factory.ContinueWhenAny(tasks.AsArrayInternal(), (Func<Task<TResult>, bool>)taskCompletionSource.TrySetResult, CancellationToken.None, TaskContinuationOptions.ExecuteSynchronously, TaskScheduler.Default);
	...
	public static Task<Task> WhenAny(IEnumerable<Task> tasks)
	{
		...
		Task.Factory.ContinueWhenAny(tasks.AsArrayInternal(), (Func<Task, bool>)taskCompletionSource.TrySetResult, CancellationToken.None, TaskContinuationOptions.ExecuteSynchronously, TaskScheduler.Default);
		return taskCompletionSource.Task;
	}
	...
	public static Task Delay(TimeSpan millisecondsDelay, CancellationToken cancellationToken)
	{
		...
		{
			throw new ArgumentOutOfRangeException("millisecondsDelay", "The timeout must be non-negative or -1, and it must be less than or equal to Int32.MaxValue.");
		}
	...
	public static Task WhenAll(IEnumerable<Task> tasks)
	{
		...
		return WhenAllCore(tasks, delegate(Task[] _, TaskCompletionSource<object> tcs)
		{
